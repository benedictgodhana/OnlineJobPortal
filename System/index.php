...
<body class="home">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/Untitled.jpeg');
">
				<div class="container">

					<h1 style="color:orange; font-weight:600">your bright future starts here now</h1>
					<p style="font-weight:600">Finding your next job or career on Nightingale Jobs</p>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								...
								<div class="process-item clearfix">
									...
									<div class="content">
										<h5 style="font-weight:600">01 / Search for jobs</h5>
									</div>
							...
							<div class="col-sm-4">
								...
								<div class="process-item clearfix">
									...
									<div class="content">
										<h5 style="font-weight:600">02 / Apply a Job</h5>
									</div>
							...
							<div class="col-sm-4">
								...
								<div class="process-item clearfix">
									...
									<div class="content">
										<h5 style="font-weight:600">03 / Start Working</h5>
									</div>
